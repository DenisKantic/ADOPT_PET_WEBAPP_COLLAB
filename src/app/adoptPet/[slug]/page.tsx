          ...
          <div className="xxs:w-full md:w-[30%] h-full rounded-2xl shadow-2xl">
            <div className="w-full h-full p-5 flex flex-col justify-between items-start text-black">
              <p className="py-2 text-[#2F5382]">
                Ime korisnika: <span className="text-black">Username</span>
              </p>
              <p className="pb-2 text-[#2F5382]">
                Broj telefona: <span className="text-black">32233232</span>
              </p>
              <p className="pb-5 text-[#2F5382]">
                Kreirano: <span className="text-black">tetetee</span>
              </p>

              {/* <div className={ (user?.id == animal.post_id) ? 'w-full flex flex-col justify-between gap-5 pt-5' : "hidden"}> */}
              <button className="btn bg-[#2F5382] text-lg text-white rounded-full w-full mt-5 hover:bg-white hover:border-[#2F5382] hover:text-[#2F5382]">
                Uredi oglas
              </button>
            </div>
