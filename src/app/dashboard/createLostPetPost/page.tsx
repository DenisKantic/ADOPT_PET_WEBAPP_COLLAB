...
const ImageUpload = () => {
  ...
  return (
    ...
    >
      <div
        className="bg-gray-100 mx-auto min-h-[50vh] shadow-2xl rounded-md
      ...
      >
        ...
        <form
          ...
          className="flex flex-col items-start w-full text-black p-5"
        >
          <div className="flex flex-col py-3 w-full">
            ...
            <div className="dropdown dropdown-bottom">
              <div
                tabIndex={0}
                role="button"
                className="btn m-1 px-6 bg-[#2F5382] text-md text-white rounded-xl mt-5"
            ...
            <div className="flex flex-col py-2">
              ...
              <div className="flex items-center py-2">
                <input
                  ...
                  name="category"
                  value="mačka"
                  className="radio radio-info border-[#2F5382]"
                />
                ...
                <input
                  ...
                  name="category"
                  value="pas"
                  className="radio radio-info ml-5 border-[#2F5382]"
                />
                <label htmlFor="category" className="ml-3">
                  Pas
                </label>
