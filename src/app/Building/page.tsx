  ...
  return (
    <div className='h-screen flex-col flex justify-center items-center p-5 bg-[#e2e6ec] text-[#2F5382]'>
        ...
        <div className='text-center'>
            ...
            <p className='py-2'>Ova putanja je trenutno u fazi izrade.</p> 
            <p>Molimo Vas za strpljenje, aplikacija je pri kraju izrade i ujedno se vrši njeno detaljno testiranje.</p>
